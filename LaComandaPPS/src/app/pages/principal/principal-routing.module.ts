...
const routes: Routes = [
  {
    ...
    component: PrincipalPage,
     children: [
       ...
       {
         path: 'mi-encuesta',
         loadChildren: () => import('../mi-encuesta/mi-encuesta.module').then( m => m.MiEncuestaPageModule)
       },
       {
         path: 'autorizaciones',
       ...
       },
       {
         ...
         loadChildren: () => import('../listado-de-pedidos/listado-de-pedidos.module').then( m => m.ListadoDePedidosPageModule)
       },
       {
         path: 'gestion-de-mesas',
         loadChildren: () => import('../gestion-de-mesas/gestion-de-mesas.module').then( m => m.GestionDeMesasPageModule)
       },
       {
         path: 'mis-tareas',
       ...
       {
         path: 'ver-encuestas',
         loadChildren: () => import('../ver-encuestas/ver-encuestas.module').then( m => m.VerEncuestasPageModule)
       },
       {
         path: 'gestion-de-productos',
         loadChildren: () => import('../gestion-de-productos/gestion-de-productos.module').then( m => m.GestionDeProductosPageModule)
       }
     ]
  }
